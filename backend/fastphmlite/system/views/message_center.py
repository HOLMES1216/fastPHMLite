...
from fastphmlite.system.models import MessageCenter, Users, MessageCenterTargetUser
...
class MessageCenterSerializer(CustomModelSerializer):
    ...
    def get_role_info(self, instance, parsed_query):
        ...
        from fastphmlite.system.views.role import RoleSerializer
    ...
    def get_user_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from fastphmlite.system.views.user import UserSerializer
