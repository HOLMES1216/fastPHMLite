...
from fastphmlite.system.models import FileList
from fastphmlite.utils.json_response import DetailResponse, SuccessResponse
...
class FileSerializer(CustomModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if file_engine == 'oss':
            from fastphmlite_cloud_storage.views.aliyun import ali_oss_upload
            ...
            from fastphmlite_cloud_storage.views.tencent import tencent_cos_upload
