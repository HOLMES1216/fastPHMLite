...
from fastphmlite.utils.core_initialize import CoreInitialize
from fastphmlite.system.fixtures.initSerializer import (
...
if __name__ == "__main__":
    Initialize(app='fastphmlite.system').run()
