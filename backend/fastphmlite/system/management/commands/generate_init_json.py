...
from fastphmlite.system.models import Menu, Users, Dept, Role, ApiWhiteList, Dictionary, SystemConfig
from fastphmlite.system.fixtures.initSerializer import UsersInitSerializer, DeptInitSerializer, RoleInitSerializer, \
