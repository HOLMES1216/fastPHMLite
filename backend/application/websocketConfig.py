...
from fastphmlite.system.views.message_center import MessageCenterTargetUserSerializer
...
def _get_message_center_instance(message_id):
    from fastphmlite.system.models import MessageCenter
...
def _get_message_unread(user_id):
    """获取用户的未读消息数量"""
    from fastphmlite.system.models import MessageCenterTargetUser
...
class FastPHMLiteWebSocket(AsyncJsonWebsocketConsumer):
...
class MegCenter(FastPHMLiteWebSocket):
    """
    消息中心
    """
