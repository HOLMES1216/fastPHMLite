...
from fastphmlite.system.views.dictionary import InitDictionaryViewSet
from fastphmlite.system.views.login import (
    LoginView,
    CaptchaView,
    ApiLogin,
    LogoutView,
...
from fastphmlite.system.views.system_config import InitSettingsViewSet
from fastphmlite.utils.swagger import CustomOpenAPISchemaGenerator
...
urlpatterns = (
        [
            ...
            path("api/system/", include("fastphmlite.system.urls")),
