...
[![img](https://img.shields.io/badge/license-MIT-blue.svg)](https://gitee.com/huge-dream/Fast-PHM-Lite/blob/master/LICENSE)  [![img](https://img.shields.io/badge/python-%3E=3.7.x-green.svg)](https://python.org/)  [![PyPI - Django Version badge](https://img.shields.io/badge/django%20versions-3.2-blue)](https://docs.djangoproject.com/zh-hans/3.2/) [![img](https://img.shields.io/badge/node-%3E%3D%2012.0.0-brightgreen)](https://nodejs.org/zh-cn/) [![img](https://gitee.com/huge-dream/Fast-PHM-Lite/badge/star.svg?theme=dark)](https://gitee.com/huge-dream/Fast-PHM-Lite)

[preview](https://demo.fastphmlite.com) | [Official website document](https://www.django-vue-admin.com) | [qq group](https://qm.qq.com/cgi-bin/qm/qr?k=fOdnHhC8DJlRHGYSnyhoB8P5rgogA6Vs&jump_from=webapi) | [community](https://bbs.django-vue-admin.com) | [plugins market](https://bbs.django-vue-admin.com/plugMarket.html) | [Github](https://github.com/liqianglog/django-vue-admin)
...
💡 [Fast-PHM-Lite](https://gitee.com/huge-dream/Fast-PHM-Lite.git) Is a set of all open source rapid development platform, no reservation for individuals and enterprises free use.
...
👩‍👧‍👦👩‍👧‍👦 demo address:[https://demo.fastphmlite.com](https://demo.fastphmlite.com)
...
gitee(Main push)：[https://gitee.com/huge-dream/Fast-PHM-Lite](https://gitee.com/huge-dream/Fast-PHM-Lite)👩‍👦‍👦
...
* Celery Asynchronous task：[fastphmlite-celery](https://gitee.com/huge-dream/fastphmlite-celery)
* Upgrade center backend：[fastphmlite-upgrade-center](https://gitee.com/huge-dream/fastphmlite-upgrade-center)
* Upgrade center front：[fastphmlite-upgrade-center-web](https://gitee.com/huge-dream/fastphmlite-upgrade-center-web)
